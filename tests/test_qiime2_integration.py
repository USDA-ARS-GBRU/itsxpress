...
if HAS_QIIME2:
    ...
    TEST_FILE_PBMD = os.path.join(TEST_DIR, "test_data", "pairedBrokenMissingData", "50d5f31a-a761-4c04-990c-e7668fe6bf00", "data")
    TEST_DATA_PBMD = SingleLanePerSamplePairedEndFastqDirFmt(TEST_FILE_PBMD, "r")

    TEST_FILE_PAF = os.path.join(TEST_DIR, "test_data", "pairedAllForward", "445cf54a-bf06-4852-8010-13a60fa1598c", "data")
    TEST_DATA_PAF = SingleLanePerSamplePairedEndFastqDirFmt(TEST_FILE_PAF, "r")

    TEST_FILE_OUT = os.path.join(TEST_DIR, "test_data", "out", "d9955749-00d5-44ae-a628-4b2da43000e1", "data")
    TEST_DATA_OUT = SingleLanePerSamplePairedEndFastqDirFmt(TEST_FILE_OUT, "r")

    TEST_FILE_SINGLEOUT = os.path.join(TEST_DIR, "test_data", "singleOut", "75aea4f5-f10e-421e-91d2-feda9fe7b2e1", "data")
    TEST_DATA_SINGLEOUT = SingleLanePerSamplePairedEndFastqDirFmt(TEST_FILE_SINGLEOUT, "r")

    TEST_FILE_SINGLEIN = os.path.join(TEST_DIR, "test_data", "singleIn", "cfd0e65b-05fb-4329-9618-15ecd0aec9b3", "data")
    ...
    class TrimTests(unittest.TestCase):
        ...
        def test_trim_pair_success(self):
            ...
            self.assertEqual(str(obs_artifact.type), 'SampleData[JoinedSequencesWithQuality]')
        ...
        def test_trim_pair_output_unmerged_success(self):
            ...
            self.assertEqual(str(obs_artifact.type), 'SampleData[PairedEndSequencesWithQuality]')
