...
- fixed bug in [Issue 56](https://github.com/USDA-ARS-GBRU/itsxpress/issues/56) that casued some FASTQ files generated by PacBio to raise an error during validation.
