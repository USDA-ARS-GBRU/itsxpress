...
setup(
    ...
    description="Rapidly trim sequences down to their Internally transcribed spacer regions",
    long_description="Rapidly trim sequences down to their Internally transcribed spacer regions",
